...
const ru = {
    ...
    orderDetails: {
        ...
        take: 'ВЗЯТЬ',
        enroute: 'В ПУТЬ',
        enrouteOkTitle: 'В пути',
        enrouteOkBody: 'Статус заказа обновлён',
        address: 'Адрес',
...
const en = {
    ...
    orderDetails: {
        ...
        take: 'TAKE',
        enroute: 'EN ROUTE',
        enrouteOkTitle: 'En route',
        enrouteOkBody: 'Order status updated',
        address: 'Address',
...
const lv = {
    ...
    orderDetails: {
        ...
        enroute: 'CEĻĀ',
        enrouteOkTitle: 'Ceļā',
        enrouteOkBody: 'Pasūtījuma statuss atjaunināts',
        address: 'Adrese',
